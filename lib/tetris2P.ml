...
let create (cols, rows) bot_enabled_1 difficulty_1 bot_enabled_2 difficulty_2 =
  let left = Tetris.create (cols, rows) bot_enabled_1 difficulty_1 in
  let right = Tetris.create (cols, rows) bot_enabled_2 difficulty_2 in
